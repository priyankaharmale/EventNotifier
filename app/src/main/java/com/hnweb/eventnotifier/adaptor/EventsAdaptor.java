...
public class EventsAdaptor extends RecyclerView.Adapter<EventsAdaptor.ViewHolder> implements Filterable {
    ...
    public EventsAdaptor(Context context, List<Event> data, String callFrom) {
    ...
    @Override
    public EventsAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View rowView = inflater.inflate(R.layout.adaptor_eventlistdemo, parent, false);
        EventsAdaptor.ViewHolder vh = new EventsAdaptor.ViewHolder(rowView);
        return vh;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(final EventsAdaptor.ViewHolder holder, final int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prefsEditor.putString("callFrom", callFrom);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewEventTitle, textViewDate, textViewTime, tv_eventendDt, tv_eventAddress, tv_eventPrice;
    ...
    private static class MyFilter extends Filter {
        ...
        private final EventsAdaptor myAdapter;
        private final List<Event> originalList;
        private final List<Event> filteredList;

        private MyFilter(EventsAdaptor myAdapter, List<Event> originalList) {
